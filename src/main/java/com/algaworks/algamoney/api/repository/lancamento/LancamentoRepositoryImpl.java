...
public class LancamentoRepositoryImpl  implements LancamentoRepositoryQuery {
    ...
    public List<LancamentoEstatisticaCategoria> porCategoria(LocalDate mesReferencia) {
        ...
        criteriaQuery.where(
                criteriaBuilder.greaterThanOrEqualTo(root.get(Lancamento_.dataVencimento), primeiroDiaMes),
                criteriaBuilder.lessThanOrEqualTo(root.get(Lancamento_.dataVencimento), ultimoDiaMes)
        );
